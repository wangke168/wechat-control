                ...
                <div class="portlet-body">
                    ...
                    @if(Session::get('eventkey')=='all')
                        <ul class="nav nav-pills">
                            ...
                            <li <?php if ($classid == '22') echo 'class=active'; ?>><a
                                        href="/control/articlelist?classid=22">公告</a></li>
                            ...
                            @foreach($rows as $row)
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        if ($row->online == 1) {
                                            echo "<span class='label label-success'>在线</span>";
                                        } else {
                                            echo "<span class='label label-danger'>已下线</span>";
                                        }
                                        if ($row->audit == 0) {
                                    ...
                                    <td>
                                        <?php
                                        echo "<a class='getqrcode label label-primary' data-target='#long' data-toggle='modal' data-src='qrcreat?type=article&id=" . $row->id . "'><i class='fa fa-eye'></i>&nbsp;预览</a>&nbsp;";
