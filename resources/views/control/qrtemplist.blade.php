            ...
            <div class="portlet box green-haze">
                ...
                <div class="portlet-body">
                    <ul class="nav nav-pills navbar-left">
                        ...
                        <button type="button" class="btn blue-madison" onclick="javascript:window.location.href='qrtemp?action=add';">添加临时二维码</button>

                    </ul>
                    {!! Form::open(['url'=>'control/qrtemp?action=search','class'=>'navbar-form navbar-right','id'=>'postForm']) !!}
                        ...
                        @foreach($rows as $row)
                            <tr>
                              ...
                              //      echo "<a href='http://weix2.hengdianworld.com/control/qr_create.php?qrscene_id=" . $row->qrscene_id . "' class='label label-warning' target='_blank'><i class=\"icon-edit\"></i>获取二维码</a>&nbsp;&nbsp;&nbsp;";
                                    echo "<a class='getqrcode label label-primary' data-target=\"#long\" data-toggle=\"modal\" data-src=\"qrcode_temp_create/" . $row->qrscene_id . "\"><i class=\"fa  fa-download\"></i>&nbsp;下载二维码</a>&nbsp;";

                                    echo "<a href='qrtemp?action=modify&id=" . $row->id . "' class='label label-success'><i class=\"fa fa-edit\"></i>&nbsp;修改</a>";
                    ...
                    <div id="long" class="modal fade " tabindex="-1" data-replace="true">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">注意:这是短期二维码</h4>
                        </div>
