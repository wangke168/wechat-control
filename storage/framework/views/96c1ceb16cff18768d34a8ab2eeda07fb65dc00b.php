...
<?php $__env->startSection('page-menu-title', '添加文章'); ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <?php else: ?>
                                    <input type="hidden" name="marketid" id="select2_sample5" readonly="readonly"
                                           ...
                                           value="<?php $usage = new \App\WeChat\Usage(); echo $usage->getArticleShowQrsecne(Session::get('eventkey'))?>">
                                <?php endif; ?>
