...
<head>
 ...
 <!--   <link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700&amp;subset=all" rel="stylesheet" type="text/css"/>
    ...
    <?php /*<link href="http://fonts.useso.com/css?family=Open+Sans:400,300,600,700&amp;subset=all" rel="stylesheet"   type="text/css"/>*/ ?>
    ...
    <link id="style_color" href="<?php echo e(asset('assets/admin/layout/css/themes/darkblue.css')); ?>" rel="stylesheet"
          type="text/css"/>
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
                <?php echo $__env->yieldContent('page-menu-title'); ?>
                <small><?php echo $__env->yieldContent('page-title'); ?></small>
            </h3>
...
<script src="<?php echo e(asset('assets/global/plugins/jquery-ui/jquery-ui-1.10.3.custom.min.js')); ?>"
