...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/global/plugins/datatables/extensions/Scroller/css/dataTables.scroller.min.css')); ?>"/>
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/global/plugins/datatables/extensions/ColReorder/css/dataTables.colReorder.min.css')); ?>"/>
						...
						<div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
							...
							<ul class="media-list list-items">
								<li class="media">
									...
									<img class="media-object" src="<?php echo e(asset('assets/admin/layout/img/avatar3.jpg')); ?>" alt="...">
								...
								<li class="media">
									<img class="media-object" src="<?php echo e(asset('assets/admin/layout/img/avatar1.jpg')); ?>" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="<?php echo e(asset('assets/admin/layout/img/avatar4.jpg')); ?>" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="<?php echo e(asset('assets/admin/layout/img/avatar2.jpg')); ?>" alt="...">
									<div class="media-body">
							...
							<ul class="media-list list-items">
								<li class="media">
									...
									<img class="media-object" src="<?php echo e(asset('assets/admin/layout/img/avatar6.jpg')); ?>" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="<?php echo e(asset('assets/admin/layout/img/avatar7.jpg')); ?>" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="<?php echo e(asset('assets/admin/layout/img/avatar8.jpg')); ?>" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="<?php echo e(asset('assets/admin/layout/img/avatar9.jpg')); ?>" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="<?php echo e(asset('assets/admin/layout/img/avatar10.jpg')); ?>" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="<?php echo e(asset('assets/admin/layout/img/avatar11.jpg')); ?>" alt="...">
									<div class="media-body">
						...
						<div class="page-quick-sidebar-item">
							<div class="page-quick-sidebar-chat-user">
								...
								<div class="page-quick-sidebar-chat-user-messages">
									<div class="post out">
										<img class="avatar" alt="" src="<?php echo e(asset('assets/admin/layout/img/avatar3.jpg')); ?>"/>
										<div class="message">
									...
									<div class="post in">
										<img class="avatar" alt="" src="<?php echo e(asset('assets/admin/layout/img/avatar2.jpg')); ?>"/>
										<div class="message">
											<span class="arrow"></span>
...
<script type="text/javascript" src="<?php echo e(asset('assets/global/plugins/datatables/extensions/Scroller/js/dataTables.scroller.min.js')); ?>"></script>
...
<!-- Mirrored from www.keenthemes.com/preview/metronic/theme/templates/admin/table_advanced.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Dec 2014 05:27:51 GMT -->
</html>