...
<head>
    ...
    <link href="<?php echo e(asset('media/css/css.css')); ?>" rel="stylesheet"
          type="text/css"/>
    ...
    <link href="<?php echo e(asset('assets/admin/pages/css/login.css')); ?>" rel="stylesheet" type="text/css"/>
    ...
    <link href="<?php echo e(asset('assets/admin/layout/css/themes/darkblue.css')); ?>" rel="stylesheet" type="text/css"
          id="style_color"/>
...
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <?php echo Form::open(['url'=>'control/login']); ?>
    ...
    <div class="form-group">
        ...
        <?php echo Form::text('username',null,['class'=>'form-control form-conrol-solid placeholder-no-fix',
    ...
    <div class="form-group">
        ...
        <?php echo Form::password('password',['class'=>'form-control form-control-solid placeholder-no-fix',
...
<script src="<?php echo e(asset('assets/global/plugins/jquery-validation/js/jquery.validate.min.js')); ?>"
