						...
						<li>
							<ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
								<li>
									...
									<span class="photo">
									<img src="<?php echo e(asset('assets/admin/layout3/img/avatar2.jpg')); ?>" class="img-circle" alt="">
									</span>
									<span class="subject">
									<span class="from">
									Lisa Wong </span>
								...
								<li>
									<a href="inbox14c8.html?a=view">
									<span class="photo">
									<img src="<?php echo e(asset('assets/admin/layout3/img/avatar3.jpg')); ?>" class="img-circle" alt="">
									</span>
									<span class="subject">
									<span class="from">
									Richard Doe </span>
								...
								<li>
									<a href="inbox14c8.html?a=view">
									<span class="photo">
									<img src="<?php echo e(asset('assets/admin/layout3/img/avatar1.jpg')); ?>" class="img-circle" alt="">
									</span>
									<span class="subject">
									<span class="from">
									Bob Nilson </span>
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="sidebar-search-wrapper">
					...
					<form class="sidebar-search " action="http://www.keenthemes.com/preview/metronic/theme/templates/admin/extra_search.html" method="POST">
				...
				<li class="tooltips" data-container="body" data-placement="right" data-html="true" data-original-title="AngularJS version demo">
					<a href="angularjs/index.html" target="_blank">
										...
										<div class="scroller" style="height: 290px;" data-always-visible="1" data-rail-visible1="1">
											<div class="row">
												<div class="col-md-6 user-info">
													<img alt="" src="<?php echo e(asset('assets/admin/layout/img/avatar.png')); ?>" class="img-responsive"/>
													<div class="details">
														<div>
															<a href="#">
															Robert Nilson </a>
					...
					<div class="portlet">
						...
						<div class="portlet-body" id="chats">
							<div class="scroller" style="height: 352px;" data-always-visible="1" data-rail-visible1="1">
								<ul class="chats">
									<li class="in">
										<img class="avatar" alt="" src="<?php echo e(asset('assets/admin/layout/img/avatar1.jpg')); ?>"/>
										<div class="message">
											<span class="arrow">
											</span>
											<a href="#" class="name">
